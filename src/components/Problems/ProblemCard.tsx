...
export default function ProblemCard({
  ...
  return (
    <div className="group w-full h-auto rounded-none flex items-center justify-center transition-all duration-0 px-10 sm:px-0 first:pt-10 sm:first:pt-0 last:pb-10 sm:last:pb-0">
