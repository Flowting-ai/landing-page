...
export default function HeroSection() {
  return (
    <div className="w-full h-auto">
      ...
      <div className="z-0 relative container mx-auto min-h-[40vh] lg:min-h-[60vh] flex flex-col items-center justify-center gap-4 px-4 lg:px-16 py-24 lg:py-30 overflow-hidden">
        ...
        <div className="z-2 text-center flex flex-col items-center gap-6 pt-[8%]">
          <h1 className="font-medium md:font-normal leading-[120%] text-2xl lg:text-[37px] xl:text-[56px] text-text">
            Simple, transparent <span className="text-[#303030]">pricing</span>
          </h1>
          <p className="max-w-xl font-geist font-normal leading-[120%] text-balance text-xs sm:text-sm lg:text-base xl:text-lg text-text">
            Choose the plan that fits your workflow. All plans include access to every model and one workspace.
          </p>
        </div>
      </div>
    </div>
