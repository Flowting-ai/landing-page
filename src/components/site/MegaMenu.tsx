  ...
  return (
    <div className="border-t border-line" style={{ background: "var(--bg-subtle)" }}>
      <div className="mx-auto flex items-center justify-between py-3" style={sheetInnerStyle}>
        ...
        <NavigationMenu.Link asChild>
          <a href={DEMO_URL} target="_blank" rel="noreferrer" onClick={() => trackEvent("book_demo_click", { location: "mega_menu" })} className="inline-flex items-center gap-1 font-sans text-[var(--text-small)] font-semibold tracking-[-0.01em] text-ink transition-colors hover:text-[color:var(--accent)]">
            Book a demo
