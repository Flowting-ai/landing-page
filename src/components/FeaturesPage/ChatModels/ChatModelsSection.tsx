  ...
  return (
    <div className="w-full h-auto mb-20">
      <div className="z-0 relative container mx-auto min-h-screen flex flex-col items-center justify-center gap-4 px-4 lg:px-16 mt-6 lg:mt-0">
        ...
        <div className="z-2 w-full h-[128px] text-left flex flex-row items-center justify-between gap-3">
          <h1 className="font-semibold leading-[120%] text-2xl lg:text-[37px] xl:text-[48px] text-black">
          One workspace, every model.
          </h1>
          <p className="max-w-xl font-normal tracking-[-0.3px] leading-[24px] text-balance text-sm lg:text-base xl:text-xl text-black">
