...
export default function HeroSection() {
  return (
    <div className="w-full h-auto lg:h-screen">
      ...
      <div className="z-0 relative container mx-auto h-full flex flex-col items-center justify-center gap-4 px-4 lg:px-16 py-30 mt-0 lg:mt-0 overflow-hidden">
        ...
        <div className="z-2 text-center flex flex-col items-center gap-3 pt-4">
          ...
          <p className="max-w-xl font-normal leading-[120%] text-balance text-xs sm:text-sm lg:text-base xl:text-lg text-text">
