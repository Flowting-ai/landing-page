    ...
    <section ref={scope} className="relative overflow-hidden pt-16 sm:pt-24 pb-16 sm:pb-20">
      ...
      <Container className="flex flex-col items-center text-center">
        ...
        <p data-reveal className="mt-6 max-w-[60ch] font-sans text-[length:var(--text-lead)] leading-[var(--text-lead--line-height)] text-ink-muted">
          Souvenir AI Agents are specialized digital coworkers — connected to all your apps,
          grounded in your shared memory, and orchestrated to execute all of your busywork.
        </p>
        <div data-reveal className="mt-8 flex flex-col sm:flex-row items-center gap-3" style={{ ["--font-size-body"]: "16px", ["--line-height-body"]: "24px" } as CSSProperties}>
          <a href={SIGNUP_URL} className="inline-flex"><Button variant="default" size="md" className="px-7 py-3" onClick={() => trackEvent("get_started_click", { location: "assistants" })}>Get started for free</Button></a>
          <a href={DEMO_URL} target="_blank" rel="noreferrer" className="inline-flex"><Button variant="secondary" size="md" className="px-7 py-3" onClick={() => trackEvent("book_demo_click", { location: "assistants" })}>Book a Demo</Button></a>
        </div>
      </Container>
