    ...
    <section ref={scope} className="relative overflow-hidden pt-16 sm:pt-24 pb-16 sm:pb-20">
      ...
      <Container className="flex flex-col items-center text-center">
        ...
        <div data-reveal className="mt-8 flex flex-col sm:flex-row items-center gap-3" style={{ ["--font-size-body"]: "16px", ["--line-height-body"]: "24px" } as CSSProperties}>
          <Button variant="default" size="md" className="px-7 py-3" onClick={() => trackEvent("get_started_click", { location: "assistants" })}>Get started for free</Button>
          <Button variant="secondary" size="md" className="px-7 py-3" onClick={() => trackEvent("book_demo_click", { location: "assistants" })}>Book a Demo</Button>
        </div>
      </Container>
