  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '• Inputs: prompts, files, images, instructions, and other content you submit to the platform ("Inputs")',
        ...
        "• Approximate geolocation: we use ip-api.com to resolve your IP address to city, region, and timezone for localization purposes. Your IP address is transmitted to this third-party service.",
    ...
    },
    {
      ...
      paragraphs: [
        "Souvenir integrates with multiple third-party AI model providers, AI services, and processing infrastructure. When you submit an Input, it may be transmitted to one or more of the following providers for processing. AI requests are routed through OpenRouter, a third-party middleware that directs your Inputs to the appropriate model provider.",
        ...
        "AI Request Routing: OpenRouter (United States) — middleware service that routes your Inputs to the appropriate AI model provider",
        "Vector Embeddings (United States): AWS Bedrock with Cohere embed-v4 — generates semantic embeddings from your content for search and memory features",
        "Document Processing (United States): AWS Textract extracts text from uploaded documents and images via OCR. Mistral OCR API may also be used for document processing on certain plans. Local parsing (PyMuPDF, python-pptx) is performed on our servers.",
        "Code Execution: User-submitted or AI-generated code may be executed in isolated Docker sandbox containers on our infrastructure in the United States.",
        ...
        "Each AI provider processes your data under their own terms and privacy policies. We share only the data necessary to fulfill your request. Under our API agreements with US- and Europe-based providers, your Inputs and Outputs are not used for model training. China-based providers may reserve the right to use inputs/outputs for model training under their own terms.",
      ],
    },
    {
      ...
      paragraphs: [
        "• Your data is primarily stored on Amazon Web Services (AWS) infrastructure in the United States. User data, conversations, personas, memories, and document embeddings are stored in a PostgreSQL database with pgvector extension. Uploaded files and documents are stored in AWS S3.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "• With service providers: including Stripe (payments), Auth0 (authentication), AWS (hosting, infrastructure, S3 storage, Textract OCR, Bedrock embeddings), OpenRouter (AI model routing), Cohere (vector embeddings via AWS Bedrock), Sentry (error monitoring — may capture request metadata and stack traces), ip-api.com (IP-based geolocation for localization), Mixpanel and Google Analytics (usage analytics), and email service providers (transactional communications)",
    ...
    },
    {
      ...
      paragraphs: [
        "Souvenir, Inc. is based in the United States. Your information is primarily stored and processed in the United States. Certain AI models process data in France, Germany, and the People’s Republic of China, as disclosed in Section 4.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "California Residents (CCPA/CPRA): You have the right to know what personal information we collect; request deletion; opt out of sale or sharing (we do not sell or share personal information); and non-discrimination. Contact info@getsouvenir.com.",
        "Other U.S. State Privacy Laws: If you reside in a state with a comprehensive privacy law (Virginia, Colorado, Connecticut, Utah, Texas, Oregon, Montana, Iowa, among others), you may have similar rights. Contact info@getsouvenir.com.",
    ...
    },
    {
      ...
      heading: "9. Security",
      paragraphs: [
        "We implement reasonable technical and organizational measures to protect your personal data, including encryption of data in transit (TLS/SSL) and at rest, role-based access controls, regular security assessments, and secure authentication protocols via Auth0.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "• Circumventing DRM",
        "2.11 Image Generation: AI-generated images (via Flux or other image models) must not depict real individuals without their consent, generate CSAM or sexually explicit imagery, create misleading deepfakes, or violate any of the prohibited content categories listed above.",
      ],
    },
    {
      id: "data-sovereignty",
      ...
      paragraphs: [
        "DeepSeek, Alibaba/Qwen, Moonshot AI/Kimi, and ChatGLM/Zhipu AI process data in China. You may disable China-based AI models (DeepSeek, Alibaba/Qwen, Moonshot AI/Kimi, and ChatGLM/Zhipu AI) at any time from your account Settings. When disabled, your data will not be transmitted to servers in the People’s Republic of China. We strongly recommend disabling China-based models for sensitive or regulated data.",
      ],
    },
    {
      id: "personas",
    ...
    },
    {
      ...
      heading: "6. Memory",
      paragraphs: [
        "You can view, edit, and delete memory from Settings. Do not store others’ personal information without consent. Data sovereignty warnings apply to memory from China-routed conversations.",
      ],
    },
    {
      id: "teams",
      heading: "7. Teams",
      paragraphs: [
        "Workspace administrators are responsible for team compliance and may disable China-based models workspace-wide.",
      ],
    },
    {
      ...
      paragraphs: [
        "You must comply with each upstream AI provider’s terms. Do not use Outputs to train competing models or represent Outputs as human-generated.",
      ],
    },
    {
      id: "dmca-takedowns",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "4.2 Multi-Model Routing: Your Inputs may be routed through OpenRouter, a third-party middleware, to one or more AI providers, including OpenAI, Anthropic, Google, xAI, Mistral AI, Jina AI, Flux/Black Forest Labs, DeepSeek, Alibaba, Moonshot AI, and ChatGLM/Zhipu AI, among others. Your content may also be processed by AWS Bedrock (Cohere) for vector embeddings, AWS Textract or Mistral for OCR, and executed in isolated Docker sandbox containers for code execution. By using our Services, you consent to this processing. Each provider operates under its own terms.",
        ...
        "4.5 AI Output Disclaimer: AI-generated Outputs may be inaccurate, incomplete, or misleading. Outputs may contain hallucinations, factual errors, or biased content. You should independently verify Outputs before relying on them. Outputs do not constitute professional advice of any kind. AI-generated images may not accurately depict real people, places, or events. AI-generated code may contain errors, security vulnerabilities, or unintended behavior — you are solely responsible for reviewing and testing any code before use in production environments.",
